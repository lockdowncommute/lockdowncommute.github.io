...
function init() {
  ...
  textureEquirec1 = textureLoader.load( "/assets/textures/StudioOff.jpg" );
  ...
  textureEquirec2 = textureLoader.load( "/assets/textures/StudioOn.jpg" );
...
audioLoader.load( 'Bex.mp3', function( buffer ) {
  ...
  $('#lightsButton').click(function(){
    if (!$('#lightsButton').hasClass('active')) {
      $('#lightsButton').addClass('active').html('Mantra');
      ...
      $('#lightsButton').removeClass('active').html('Office');
      equirectMaterial.uniforms[ "tEquirect" ].value = textureEquirec1;
